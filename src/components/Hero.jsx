    ...
    <section className="relative w-full h-screen mx-auto">
      <div className={`${styles.paddingX} absolute inset-0 top-[120px] max-w-7xl mx-auto
       flex flex-row items-start gap-5`}>
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>Hi, I'm <span className="text-[#915eff]">Ritika</span> </h1>
          <p className={`${styles.heroSubText}mt-2 text-white-100`}>I'm an Engineering student and I love coding<br className="sm:block hidden"/> and developing interfaces and web application.</p>
        </div>
       ...
       <div className="absolute xs:bottom-1 bottom-32 w-full flex justify-center items-center">
        <a href="#about">
          <div className="w-[30px] h-[54px] rounded-3xl border-4 border-secondary flex justify-center items-start p-2">
            ...
            className="h-2 w-5 rounded-full bg-secondary mb-1"           
            />
          </div>
        </a>
       </div>
